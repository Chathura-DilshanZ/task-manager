                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.assign-task', $user) }}" method="POST">
                        ...
                        <div class="flex items-center justify-end mt-4">
                            <a href="{{ route('admin.users') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 mr-3">
                                {{ __('Cancel') }}
                            </a>
